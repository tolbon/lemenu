...
CREATE TABLE `menu_has_menu_section` (
  ...
  `menu_section_parent_id` int(11) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UIDX_9AEC8DF98E57A8` (`menu_id`,`menu_section_parent_id`,`menu_section_id`,`position`),
...
INSERT INTO `menu_has_menu_section` VALUES (4,2,NULL,1,'2021-08-03 09:45:18',1),(5,2,1,2,'2021-08-03 09:45:18',1),(6,2,1,3,'2021-08-03 09:45:18',2);
...
INSERT INTO `menu_item` VALUES (1,'CLASSIC','Boeuf, comté affiné 18 mois, laitue iceberg,',9.4,1,'2021-07-25 21:33:18'),(2,'WALLACE','Boeuf, blue stilton, bacon de boeuf,',9.4,1,'2021-07-25 21:33:18'),(3,'Rosa (Végétarien)','Poivrons grillés, aubergines grillées, gros champignon',8.4,1,'2021-07-25 21:33:18'),(5,'CHAMPIGNON PORTOBELLO','Un champignon frais, snacké à la plancha.',NULL,1,'2021-07-25 21:33:18'),(6,'STEAK VEGAN BEYOND MEAT','Un steak surprenant de légumes, protéiné, sans gluten et sans OGM',2.5,1,'2021-07-25 21:33:18'),(7,'Doublez votre viande ou ?',' ajoutez du ? ou du bacon',10000.5,1,'2021-07-25 21:33:18'),(8,'ajoutez des ingrédients','Tomates confites, champignons caramélisés, oignons caramélisés, oignons rouges, poivrons grillés, cornichons, aubergines.',1,1,'2021-07-25 21:33:18');
...
CREATE TABLE `menu_section` (
  ...
  `display_children_section_after_menuItems` tinyint(4) NOT NULL,
  `insert_date_db` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '(DC2Type:datetimetz_immutable)',
  `restaurant_id` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `IDX_A5A86751F98E57A8` (`menu_section_id`),
  ...
  CONSTRAINT `FK_A5A86751F98E57A8` FOREIGN KEY (`menu_section_id`) REFERENCES `menu_section` (`id`)
...
INSERT INTO `menu_section` VALUES (1,NULL,'Burger','Nos viandes* sont cuites à point, n’hésitez pas à préciser votre cuisson !',NULL,0,1,0,0,'2021-07-25 21:35:26',1),(2,1,' ENVIE D\'UN VÉGÉ ?','2 CHOIX POUR REMPLACER NOTRE STEAK :',NULL,0,1,0,0,'2021-07-25 21:35:26',1),(3,1,'→ une grosse faim ?',' ',NULL,0,1,0,0,'2021-07-25 21:35:26',1);
...
INSERT INTO `menu_section_menu_item` VALUES (1,1),(1,2),(1,3),(2,5),(2,6),(3,7),(3,8);
...
INSERT INTO `restaurant` VALUES (1,'Rosaparks','ROSAPARKS TROYES','EUR',1,'rosaparks','',''),(2,'Le BÔ$phɵǒrœ ȘỚỸßØå','Kébab Frêre Ô$phɵǒrœ ȘỚỸßØå','EUR',1,'bosphore','','');
...
-- Dump completed on 2021-08-04 16:54:13
